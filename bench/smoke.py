...
def main():
    ...
    try:
        ...
        base={"model":"Qwen/Qwen3.8-27B","messages":[{"role":"user","content":"Reply with exactly: smoke-ok"}],"temperature":0,"max_tokens":16}
        ...
        status,body=call(a.base_url+"/v1/chat/completions",{**base,"reasoning_effort":"none"}); assert status==200; assert_chat(body,"reasoning"); checks["reasoning_control"]=True; results.append({"path":"reasoning","status":status,"body":body})
